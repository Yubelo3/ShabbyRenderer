...
int main()
{
    ...
    ObjPtr sphere1 = std::make_shared<Shpere>(Vec3{0.0f, 0.0f, -5.0f}, 1.0f);
    ObjPtr sphere2 = std::make_shared<Shpere>(Vec3{-2.0f, 2.0f, -10.0f}, 1.0f);
    ...
    LightPtr light1 = std::make_shared<PointLight>(Vec3{20.0f, 20.0f, 20.0f}, Vec3{0.0f, 0.0f, 0.0f});
